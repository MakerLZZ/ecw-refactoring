            ...
            <div className='orderDetail-container'>
                ...
                <div className='orderDetail-container-right'>
                    ...
                    <div className='orderDetail-container-right-time'>
                        您还有 
                        <span>
                            <CountDown endTime={moment(orderInfo.createTime).add(7, 'days').format('YYYY-MM-DD HH:mm:ss')}/>
                        </span>
                         来付款，超时订单自动关闭
                    </div>
                    <div className='orderDetail-container-right-submit'>
                        您可以
                        <Button type="primary" onClick={this.payOrder}>付款</Button>
                        <Button type="link" onClick={this.cancleOrder}>取消订单</Button>
                    </div>
                </div>
            </div>
        );
